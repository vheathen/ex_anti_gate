defmodule ExAntiGate.Application do
  ...
  def start(_type, _args) do
    ...
    if is_nil(ExAntiGate.Config.get(:api_key)) do
      raise ArgumentError, """
      ...
      or via environment variable `EX_ANTI_GATE_API_KEY`. The last option has preference over the one set on configuration file.
    ...
    children =
      if ExAntiGate.Config.get(:autostart) do
